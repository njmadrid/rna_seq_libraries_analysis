...
files <- dir(path="/data/projects/rna_prep_comparison/star", pattern=".*_Aligned.*.bedgraph.gz",full.names = T)
...
write.csv(summarydf, "editingSiteCoverage.csv")
write.csv(as.data.frame(filteredRadarRanges), "radarSiteCoverage.csv")
write.csv(as.data.frame(filteredDarnedRanges), "darnedSiteCoverage.csv")
